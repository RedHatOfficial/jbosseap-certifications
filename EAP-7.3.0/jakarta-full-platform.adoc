...
----
Date:  19-Jan-2020
Product Name:  Red Hat JBoss Enterprise Application Platform 7.3
...
https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE8/EAP-7.3.0/jakarta-full-platform.adoc[Red Hat JBoss Enterprise Application Platform 7.3.0.GA TCK results]
