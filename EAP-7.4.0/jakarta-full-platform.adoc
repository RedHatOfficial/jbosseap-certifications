...
https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE8/EAP-7.4.0/jakarta-full-platform.adoc[Red Hat JBoss Enterprise Application Platform 7.4.0.GA TCK results]
