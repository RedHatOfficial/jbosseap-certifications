...
https://github.com/RedHatOfficial/jbosseap-certifications/EAP-7.4.0/jakarta-web-profile.adoc[Red Hat JBoss Enterprise Application Platform 7.4.0.GA TCK results]
