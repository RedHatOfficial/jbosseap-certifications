= Jakarta Core Profile 10 TCK Java SE 11 Results
...
https://https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE10/EAP-8.0.0/jakarta-core-jdk11.adoc#jakarta-core-profile-10-tck-java-se-11-results[JBoss EAP 8.0.0 TCK results]
