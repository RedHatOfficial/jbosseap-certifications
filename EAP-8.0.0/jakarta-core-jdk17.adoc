...
https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE10/EAP-8.0.0/jakarta-core-jdk17.adoc#jakarta-core-profile-10-tck-java-se-17-results[JBoss EAP 8.0.0 TCK results]
