= Jakarta Core Profile 10 TCK Java SE 17 Results
...
https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE10/EAP-8.0.0/jakarta-full-platform.adoc#jakarta-core-profile-1000-tck-java-se-17-results[JBoss EAP 8.0.0 TCK results]
