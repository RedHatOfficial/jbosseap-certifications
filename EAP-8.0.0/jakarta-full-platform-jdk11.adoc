...
=== JBoss Enterprise Application Platform Full Platform, Certification Summary
----
...
https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE10/EAP-8.0.0/jakarta-full-platform-jdk11.adoc#tck-results[JBoss EAP 8.0.0 TCK results]
...
(Two tests were excluded due to the challenge at https://github.com/jakartaee/jaxb-tck/issues/82)
