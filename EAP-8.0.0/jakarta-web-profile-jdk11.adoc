...
=== JBoss Enterprise Application Platform Web Profile, Certification Summary
----
...
https://github.com/RedHatOfficial/jbosseap-certifications/blob/EE10/EAP-8.0.0/jakarta-web-profile-jdk11.adoc#tck-results[JBoss EAP 8.0.0 TCK results]
